...
function HomeNavigation() {
  ...
  const navLinks = [
    ...
    { name: 'Report Emergency', action: () => navigate('/victim') },
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-[#9CAF88] to-[#7A9A6D] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        >
          Our emergency report wizard helps you quickly communicate your situation to the nearest rescue authorities.
        </motion.p>
